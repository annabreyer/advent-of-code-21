...
class FirstDecemberController extends AbstractController
{
    /** @var DepthManager */
    private $depthManager;

    public function __construct(DepthManager $depthManager)
    {
        $this->depthManager = $depthManager;
    }

    /**
     * @Route("/december/1", name="december-1", methods={"GET"})
     */
    public function getNumberOfIncreases(): Response
    {
        $data              = $this->getDepths();
